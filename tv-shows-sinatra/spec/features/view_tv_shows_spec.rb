...
feature "user views list of TV shows" do
  ...
  scenario "view details for a TV show" do
    TelevisionShow.create!({
        title: "Married... with Children", network: "Fox",
        starting_year: 1987, ending_year: 1997,
        genre: "Comedy", synopsis: "Al Bundy is an unsuccessful middle aged shoe salesman with a miserable life and an equally dysfunctional family. ... He hates his job, his wife is lazy, his son is dysfunctional (especially with women), and his daughter is dim-witted and promiscuous."
    })
  ...
  scenario "view details for a TV show with missing information" do
    TelevisionShow.create!({
        title: "Married... with Children", network: "Fox",
        starting_year: 1987, genre: "Comedy"
    })
    ...
    expect(page).to have_content('Comedy')
    expect(page).to_not have_content('Al Bundy is an unsuccessful middle aged shoe salesman with a miserable life and an equally dysfunctional family. ... He hates his job, his wife is lazy, his son is dysfunctional (especially with women), and his daughter is dim-witted and promiscuous.')
  end
end
